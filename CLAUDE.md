...
- **Não existem mais "nomes de feature em inglês".** Os três que havia foram desfeitos na Fase 0: "Finance Lite" → **Financeiro**, "Care Radar" → **Care**, "Journey Map" → **Journey**. A regra que sobrou é simples e vale para nome novo: **o termo de produto sobrevive, o substantivo em inglês grudado nele cai** — Care e Journey estão na lista de não traduzir; "Radar", "Map" e "Lite" nunca estiveram. Não reintroduza nenhum dos três. "Timeline" é tratada como conceito do Tally (a memória da igreja) e fica em inglês.
