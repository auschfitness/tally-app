...
import { hydrateAttendance } from "./attendance-repo.js";
import { hydrateJourney } from "./journey-repo.js";
import { hydrateGroupMembers } from "./group-members-repo.js";
import { hydrateTracks } from "./tracks-repo.js";
import { hydrateSermons } from "./sermons-repo.js";
import { hydrateSeries } from "./series-repo.js";
import { hydrateScriptures } from "./scriptures-repo.js";
import { hydrateNotes } from "./notes-repo.js";
import { hydrateResources } from "./resources-repo.js";
import { hydrateMinistries } from "./ministries-repo.js";
import { hydrateTeams } from "./teams-repo.js";
import { hydrateSchedule } from "./schedule-repo.js";
import { hydrateServices } from "./services-repo.js";
import { hydratePlanItems } from "./service-plan-repo.js";
import { hydrateEvents, hydrateEventRegs } from "./events-repo.js";
...
function loadOrg(orgId){setOrg(orgId);
  SB.from("app_state").select("data").eq("org_id",orgId).maybeSingle().then(function(r){
   if(r.error){gateError(r.error.message);return;}
   if(r.data&&r.data.data&&r.data.data.institution){setState(r.data.data);Promise.all([hydratePeople(state),hydrateGroups(state),hydratePrayers(state),hydrateEntries(state)]).then(function(){return hydrateAttendance(state);}).then(function(){return hydrateGroupMembers(state);}).then(function(){return hydrateJourney(state);}).then(function(){return hydrateTracks(state);}).then(function(){return hydrateSeries(state);}).then(function(){return hydrateSermons(state);}).then(function(){return hydrateScriptures(state);}).then(function(){return hydrateNotes(state);}).then(function(){return hydrateResources(state);}).then(function(){return hydrateMinistries(state);}).then(function(){return hydrateTeams(state);}).then(function(){return hydrateSchedule(state);}).then(function(){return hydrateServices(state);}).then(function(){return hydratePlanItems(state);}).then(function(){return hydrateEvents(state);}).then(function(){return hydrateEventRegs(state);}).then(function(){render();hideGate();});return;}
   SB.from("organizations").select("name,currency").eq("id",orgId).single().then(function(o){
    SB.from("campuses").select("name").eq("org_id",orgId).then(function(cs){
     ...
     SB.from("app_state").upsert({org_id:orgId,data:s,updated_by:USER.id}).then(function(){Promise.all([hydratePeople(state),hydrateGroups(state),hydratePrayers(state),hydrateEntries(state)]).then(function(){return hydrateAttendance(state);}).then(function(){return hydrateGroupMembers(state);}).then(function(){return hydrateJourney(state);}).then(function(){return hydrateTracks(state);}).then(function(){return hydrateSeries(state);}).then(function(){return hydrateSermons(state);}).then(function(){return hydrateScriptures(state);}).then(function(){return hydrateNotes(state);}).then(function(){return hydrateResources(state);}).then(function(){return hydrateMinistries(state);}).then(function(){return hydrateTeams(state);}).then(function(){return hydrateSchedule(state);}).then(function(){return hydrateServices(state);}).then(function(){return hydratePlanItems(state);}).then(function(){return hydrateEvents(state);}).then(function(){return hydrateEventRegs(state);}).then(function(){render();hideGate();});});});});});}
