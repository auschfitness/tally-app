...
document.querySelectorAll(".navitem").forEach(n=>n.onclick=()=>{state.view=n.dataset.view;state.stickDetail=null;state.groupDetail=null;state.teamDetail=null;save();render();});
